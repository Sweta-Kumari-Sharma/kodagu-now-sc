...
const Search = () => {
  return (
    <div className='hidden md:flex  space-x-5 ml-8 my-2 items-center'>
        ...
        <div className='flex space-x-2 items-center justify-self-center'>
          <Image src={Lock} className="flex h-[14px] mt-[-4px] w-[13px] justify-self-center"></Image>
          <div className='mt-[-4px]  text-[#4C4C4C] text-[14px]'>constructor.spline.one</div>
        </div>
